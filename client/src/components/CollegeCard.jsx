...
const CollegeCard = ({ image, name, place }) => {
  return (
    <div className="flex flex-col w-[20em] h-[18em] p-2 bg-white justify-center items-center rounded-md  border border-gray-200 shadow-md transition ease-in-out hover:scale-110 hover:z-40 cursor-pointer">
